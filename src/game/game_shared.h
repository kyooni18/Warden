...
/*
 * game_shared.h — Internal shared types and declarations for the Warden game.
 *
 * This header is an implementation detail of src/game/; it is NOT part of the
 * public engine API.  External callers should include include/game/game.h only.
 *
 * Engine utility functions (clamp_int, roll_range, …) are provided by the
 * engine/utils module and declared via the include below.
 */
...
/* Engine utility functions (clamp_int, roll_range, is_blank, …). */
